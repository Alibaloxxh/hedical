  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Refund &amp; Cancellation Policy</h1>
        <p className="mt-2 text-sm text-muted">Last updated: July 2026</p>

        <div className="mt-8 prose prose-sm text-muted space-y-6">
          <h2 className="text-xl font-semibold text-foreground">1. Subscriptions (Unlimited Plan)</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-foreground">2. Per-Use Purchases</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-foreground">4. How to Cancel</h2>
          <p>
